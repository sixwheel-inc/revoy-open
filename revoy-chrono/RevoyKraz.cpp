...
void RevoyKraz::SetChassisVisualizationType(VisualizationType vis_tractor,
...
void RevoyKraz::SetSuspensionVisualizationType(VisualizationType vis_tractor,
                                               VisualizationType vis_trailer) {
...
void RevoyKraz::SetWheelVisualizationType(VisualizationType vis_tractor,
                                          VisualizationType vis_trailer) {
  m_tractor->SetWheelVisualizationType(vis_tractor);
  m_trailer->SetWheelVisualizationType(vis_trailer);
}

void RevoyKraz::SetTireVisualizationType(VisualizationType vis_tractor,
                                         VisualizationType vis_trailer) {
...
void RevoyKraz::Initialize() {
  ...
  auto drvLine =
      std::static_pointer_cast<ChShaftsDriveline4WD>(m_tractor->GetDriveline());
  ...
  case TransmissionModelType::AUTOMATIC_SHAFTS:
    // transmission =
    // chrono_types::make_shared<Kraz_tractor_AutomaticTransmissionShafts>("Transmission");
    break;
  ...
  m_tractor->InitializeTire(tire_FL, m_tractor->GetAxle(0)->m_wheels[0],
                            VisualizationType::NONE);
  m_tractor->InitializeTire(tire_FR, m_tractor->GetAxle(0)->m_wheels[1],
                            VisualizationType::NONE);

  m_tractor->InitializeTire(tire_RL1i, m_tractor->GetAxle(1)->m_wheels[0],
                            VisualizationType::NONE);
  m_tractor->InitializeTire(tire_RR1i, m_tractor->GetAxle(1)->m_wheels[1],
                            VisualizationType::NONE);
  m_tractor->InitializeTire(tire_RL1o, m_tractor->GetAxle(1)->m_wheels[2],
                            VisualizationType::NONE);
  m_tractor->InitializeTire(tire_RR1o, m_tractor->GetAxle(1)->m_wheels[3],
                            VisualizationType::NONE);

  m_revoy->InitializeTire(tire_RL2i, m_tractor->GetAxle(2)->m_wheels[0],
                          VisualizationType::NONE);
  m_revoy->InitializeTire(tire_RR2i, m_tractor->GetAxle(2)->m_wheels[1],
                          VisualizationType::NONE);
  m_revoy->InitializeTire(tire_RL2o, m_tractor->GetAxle(2)->m_wheels[2],
                          VisualizationType::NONE);
  m_revoy->InitializeTire(tire_RR2o, m_tractor->GetAxle(2)->m_wheels[3],
                          VisualizationType::NONE);
  ...
  m_revoy->InitializeTire(r_tire_Li, m_revoy->GetAxle(0)->m_wheels[0],
                          VisualizationType::PRIMITIVES);
  m_revoy->InitializeTire(r_tire_Lo, m_revoy->GetAxle(0)->m_wheels[1],
                          VisualizationType::PRIMITIVES);
  m_revoy->InitializeTire(r_tire_Ri, m_revoy->GetAxle(0)->m_wheels[2],
                          VisualizationType::PRIMITIVES);
  m_revoy->InitializeTire(r_tire_Ro, m_revoy->GetAxle(0)->m_wheels[3],
                          VisualizationType::PRIMITIVES);
  ...
  m_trailer->InitializeTire(tr_tire_FL, m_trailer->GetAxle(0)->m_wheels[0],
                            VisualizationType::NONE);
  m_trailer->InitializeTire(tr_tire_FR, m_trailer->GetAxle(0)->m_wheels[1],
                            VisualizationType::NONE);
  m_trailer->InitializeTire(tr_tire_ML, m_trailer->GetAxle(1)->m_wheels[0],
                            VisualizationType::NONE);
  m_trailer->InitializeTire(tr_tire_MR, m_trailer->GetAxle(1)->m_wheels[1],
                            VisualizationType::NONE);
  m_trailer->InitializeTire(tr_tire_RL, m_trailer->GetAxle(2)->m_wheels[0],
                            VisualizationType::NONE);
  m_trailer->InitializeTire(tr_tire_RR, m_trailer->GetAxle(2)->m_wheels[1],
                            VisualizationType::NONE);
...
void RevoyKraz::Synchronize(double time, const DriverInputs &driver_inputs,
                            const DriverInputs &revoy_inputs,
                            const ChTerrain &terrain) {

  m_tractor->Synchronize(time, driver_inputs, terrain);
  m_revoy->Synchronize(time, revoy_inputs, terrain);
